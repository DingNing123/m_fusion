...
def print_hi(name):
    ...
    model_name = 'lf_dnn'
    RESULT_FILE = work_dir + "output/v_speaker_only/{}.json"
    ...
    class LF_DNN(nn.Module):
        def __init__(self, speakers_num):
            ...
            self.post_fusion_layer_1 = nn.Linear( self.video_hidden + self.speakers_num , self.post_fusion_dim)
            self.post_fusion_layer_2 = nn.Linear(self.post_fusion_dim, self.post_fusion_dim)
            self.post_fusion_layer_4 = nn.Linear(self.post_fusion_dim + self.speakers_num, self.post_fusion_dim1)
        ...
        def forward(self, text_x, video_x, audio_x, speaker_x, context_text_x):
            ...
            # 128+32+16 = 176
            fusion_h = torch.cat([video_h, speaker_x], dim=-1)
