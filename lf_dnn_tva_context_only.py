...
def print_hi(name):
    ...
    model_name = 'lf_dnn'
    RESULT_FILE = work_dir + "output/tva_context_only/{}.json"
    ...
    class LF_DNN(nn.Module):
        def __init__(self, speakers_num):
            ...
            self.post_fusion_layer_1 = nn.Linear(self.text_hidden + self.video_hidden + self.audio_hidden
                                                 + self.context_text_hidden , self.post_fusion_dim)
        ...
        def forward(self, text_x, video_x, audio_x, speaker_x, context_text_x):
            ...
            # 128+32+16 = 176
            fusion_h = torch.cat([video_h, text_h, audio_h, context_text_h], dim=-1)
