...
def print_hi(name):
    ...
    model_name = 'lf_dnn'
    RESULT_FILE = work_dir + "output/v/{}.json"
    ...
    class LF_DNN(nn.Module):
        def __init__(self):
            ...
            self.post_fusion_layer_1 = nn.Linear(self.video_hidden, self.post_fusion_dim )
        ...
        with torch.no_grad():
            with tqdm(dataLoader) as td:
                for batch_data in td:
                    ...
                    outputs,_ = model2(text, vision, audio)
        ...
        while True:
            ...
            with tqdm(train_dataLoader) as td:
                for batch_data in td:
                    ...
                    optimizer.zero_grad()
                    # forward
                    outputs ,representations  = model2(text, vision, audio)
            ...
            if val_acc > best_acc:
                ...
                path = work_dir + 'representation/visual'
