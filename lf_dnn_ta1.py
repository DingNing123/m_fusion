...
def print_hi(name):
    ...
    model_name = 'lf_dnn'
    RESULT_FILE = work_dir + "output/ta/{}.json"
    ...
    class LF_DNN(nn.Module):
        def __init__(self):
            ...
            self.post_fusion_layer_1 = nn.Linear(self.text_hidden  + self.audio_hidden, self.post_fusion_dim )
        ...
        def forward(self, text_x, video_x, audio_x):
            ...
            # 128+32+16 = 176
            fusion_h = torch.cat([ text_h, audio_h], dim=-1)
