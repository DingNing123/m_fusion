...
def print_hi(name):
    ...
    RESULT_FILE = work_dir + "output/independent/tv/{}.json"
    ...
    class LF_DNN(nn.Module):
        def __init__(self):
            ...
            self.post_fusion_layer_1 = nn.Linear(self.text_hidden  + self.video_hidden+self.text_in
                                                 +self.video_in , self.post_fusion_dim1 )
            ...
            self.post_fusion_layer_6 = nn.Linear(self.post_fusion_dim1 + self.text_in +self.video_in , self.post_fusion_dim1)
        ...
        def forward(self, text_x, video_x, audio_x):
            ...
            # 128+32+16 = 176
            fusion_h = torch.cat([text_h, video_h , text_x, video_x, ], dim=-1)
